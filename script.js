...
const LETTER_GROUPS = {
  1: {
    body1: 'Heading home for Holi or planning a festive short break? This Holi, turn your travel plans into something special.',
    body2: 'Enjoy up to <strong>10% cashback</strong> on <strong>flights and travel bookings</strong> on MakeMyTrip, Yatra, and more.',
    ctaLabel: 'Claim Now',
    ctaLink: '#',
  ...
  3: {
    body1: 'You have been making great use of your card this year. Your card deserves a festive upgrade too.',
    body2: 'Get up to <strong>33% savings on PharmEasy and IGP<strong>, and up to <strong>16% savings<strong> on <strong>brand vouchers<strong> this Holi.',
    ctaLabel: 'Claim Now',
    ctaLink: '#',
    image: 'assets/letter-img-3.png',
  },
  4: {
    body1: 'You have been using your Zapp Account balance for quick everyday payments. Make your festive season clean & clutter-free..',
    body2: 'Get <strong>₹50 cashback on loading your Zapp Account<strong> using any credit card.',
    ctaLabel: 'Add Money',
    ctaLink: '#',
    image: 'assets/letter-img-4.png',
  },
  5: {
    body1: 'You use UPI regularly for your payments. Celebrate the festival with smarter UPI payments.',
    body2: 'Link your RuPay Credit Card on PayZapp, complete 2 UPI payments, and <strong>earn ₹250 cashback<strong>.',
