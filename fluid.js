...
// Automatically splash a colorful explosion occasionally
setInterval(function () {
    var numSplats = Math.floor(Math.random() * 2) + 1; // 1 to 2 splats simultaneously
